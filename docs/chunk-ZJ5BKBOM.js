import{a as W,b as P}from"./chunk-KJPPBXDO.js";import{a as C,b as w,c as D,d as M,e as I,f as _,g as T}from"./chunk-6IHYB2AV.js";import"./chunk-IMEODX4F.js";import"./chunk-PRB5TZSC.js";import{p as S,q as E}from"./chunk-H3I524XT.js";import{p as k}from"./chunk-EFMPFDS6.js";import"./chunk-4IVXAVEU.js";import{Ab as t,Bb as e,Cb as c,Nb as g,Ob as v,Sa as s,ac as n,bc as u,gb as y,pa as r,tb as d,ub as m,zb as p}from"./chunk-ANFRTOHF.js";import"./chunk-6HR7AMTL.js";function O(o,l){if(o&1&&c(0,"p-message",19),o&2){let i=v();p("text",i.violationResult())}}function V(o,l){if(o&1&&c(0,"p-message",23),o&2){let i=v();p("text",i.solutionResult())}}var b=class{work(){console.log("Developer working")}eat(){console.log("Developer eating")}sleep(){console.log("Developer sleeping")}code(){console.log("Developer coding")}design(){}manage(){}},f=class{work(){console.log("Manager working")}eat(){console.log("Manager eating")}sleep(){console.log("Manager sleeping")}code(){}design(){}manage(){console.log("Manager managing")}},x=class{work(){console.log("Developer working")}eat(){console.log("Developer eating")}sleep(){console.log("Developer sleeping")}code(){console.log("Developer coding")}},h=class{work(){console.log("Manager working")}eat(){console.log("Manager eating")}sleep(){console.log("Manager sleeping")}manage(){console.log("Manager managing")}},R=class o{violationCode=`
