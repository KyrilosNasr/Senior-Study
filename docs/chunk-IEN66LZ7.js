import{a as R,b as U,c as H}from"./chunk-7V3YUGU4.js";import{a as j,b as O}from"./chunk-S2OXY7KE.js";import"./chunk-ZCBYKFSK.js";import"./chunk-BNU3XHMI.js";import"./chunk-ZNZEMCYO.js";import{e as D,i as k,p as M}from"./chunk-5TVMUKYR.js";import{b as I}from"./chunk-VHQBVC6O.js";import{a as C,b as T,c as L,d as q,e as A,f as _,g as Q,h as P}from"./chunk-AH7MQ5KM.js";import"./chunk-K33OWSJ3.js";import"./chunk-UB7WHAP5.js";import{p as E,q as w}from"./chunk-47HPTYDK.js";import{p as S}from"./chunk-FHCI6K3X.js";import"./chunk-FPPZ4BUR.js";import{$b as y,Hb as x,Jb as u,Ma as o,Xb as i,Yb as d,ab as p,ac as h,bc as v,nb as b,ob as f,tb as g,ub as e,va as c,vb as t,wb as a}from"./chunk-S2MQBBOY.js";import"./chunk-6HR7AMTL.js";function F(l,r){if(l&1&&(e(0,"div",51)(1,"h4",61),a(2,"i",34),i(3," Result "),t(),e(4,"p",62),i(5),t()()),l&2){let n=u();o(5),d(n.result())}}var N=class l{selectedDatabase=c("mysql");result=c("");violationCode=`
...
`;databases=[{label:"MySQL",value:"mysql"},{label:"PostgreSQL",value:"postgres"},{label:"MongoDB",value:"mongodb"}];testAbstraction(){let r;switch(this.selectedDatabase()){case"mysql":r=new R;break;case"postgres":r=new U;break;case"mongodb":r=new H;break;default:this.result.set("Invalid database selection");return}try{r.connect();let n=r.query("SELECT * FROM users");r.disconnect(),this.result.set(`Successfully used ${this.selectedDatabase()} database through Database interface.
